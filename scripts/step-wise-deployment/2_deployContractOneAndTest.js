...
async function main() {
    ...
    const salt = "0x09888Addf726E6B04dBc6bd8BFE5Bf4A924D597F000000000000000000000008";
    let tnx1 = await metamorphicContractFactory.deployMetamorphicContract(salt,contractOneABI.bytecode, "0x")
